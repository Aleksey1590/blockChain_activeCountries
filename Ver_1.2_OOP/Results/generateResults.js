...
Stats.prototype= {
	constructor: Stats,
	updateResults: function (country, popSize, absolute, callback_){
		for (let i=0; i < (Stats.absolute.length); i++){
		}
	}

// 	getAbsoluteResults: function() { return this.absolute.map(function(c) {
// 		return {
// 			f: c.f,
// 			f2: c.f2,
// 			f3: c.f3
...
// 	}) 
// },
	//getRelativeResults: function() { return this.relative; }
